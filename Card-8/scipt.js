...
`;
const containerCardBgYellowBox = document.createElement("div");
containerCardBgYellowBox.classList = "container-card bg-yellow-box";
containerCardBgYellowBox.innerHTML = `
    <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
...
cardTitle.innerText = "Get Yield on Deposits";
containerCardBgYellowBox.appendChild(cardTitle);
...
containerCardBgYellowBox.appendChild(cardDescription);
thirdCard.appendChild(containerCardBgYellowBox);

const containerCardBgBlueBox = document.createElement("div");
containerCardBgBlueBox.classList = "container-card bg-blue-box";
containerCardBgBlueBox.innerHTML = `
    <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
...
cardTitle2.classList = "card-title";
cardTitle2.innerText = "Get up to 11x Leverage";
containerCardBgBlueBox.appendChild(cardTitle2);

const cardDescription2 = document.createElement("p");
cardDescription2.classList = "card-description";
cardDescription2.innerText =
  "Hubble’s capital-efficient 110% collateral ratio lets users leverage up to 11x on their deposits.";
containerCardBgBlueBox.appendChild(cardDescription2);
fourthCard.appendChild(containerCardBgBlueBox);
