...
const humanResources = document.querySelector(".human-resources");
...
`;
cardTwo.appendChild(circleEl);
const pTag = document.createElement("p");
pTag.innerText = "Credentialing";
cardTwo.appendChild(pTag);

const overlay2 = document.createElement("div");
overlay2.classList = "overlay";
cardThree.appendChild(overlay2);
...
<g id="icon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
    ...
    <rect id="Rectangle-3" fill="#6A5297" x="67.8357511" y="38.776399" width="9.40495664"
...
`;
cardThree.appendChild(circle2);
const pTag2 = document.createElement("p");
pTag2.innerText = "Wallet";
cardThree.appendChild(pTag2);

const overlay = document.createElement("div");
overlay.classList = "overlay";
humanResources.appendChild(overlay);
...
`;
humanResources.appendChild(circle);

const pTagEl = document.createElement("p");
pTagEl.innerText = "Human Resources";
humanResources.appendChild(pTagEl);
